...
const SimpleIteration = () => {
  ...
  const handleStart = () => {
    ...
    // console.log("resultMatrix", resultMatrix);
    const res = simpleIterationMethod(
      resultMatrix,
      resultVector,
      initialGuess,
      tolerance,
...
export default SimpleIteration;
...
function simpleIterationMethod(A, b, initialGuess, tolerance, maxIterations) {
  const n = A.length;
